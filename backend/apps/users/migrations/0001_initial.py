    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('admin', 'Admin'), ('operator', 'Operator')], default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='users.postalcode')),
            ],
        ),
        migrations.CreateModel(
            name='State',
